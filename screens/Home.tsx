...
import {getAnimeAiring, getAnimeMovie, getAnimeUpcoming, getPopularAnime, getTopManga, getTopNovels} from '../model/jikanAPI'
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={{marginBottom: 50}}>
        ...
        <View style={styles.headWrap}>
          ...
          <Image source={Logo} width={20} height={15} resizeMode="contain" style={styles.logoImage} />
        </View>
        <ListCarousel data={animeUpcoming && animeUpcoming.slice(0, 10)} navigation={navigation} />
        ...
        <View style={styles.containerSection}>
          <View style={styles.headingSecttion}>
            ...
            <TouchableOpacity
              onPress={() => navigation.navigate("ListScreen", {itemType: "anime",title: "Airing Anime",type: "airing"})}
            >
              <AntDesign name="arrowright" size={20} color="white" />
            </TouchableOpacity>
          </View>
          <ListItem data={airingAnime} navigation={navigation} square type="anime"/>
        </View>
        ...
        <View style={styles.containerSection}>
          <View style={styles.headingSecttion}>
            ...
            <TouchableOpacity
              onPress={() => navigation.navigate("ListScreen", {itemType: "anime",title: "TOP Movie",type: "movie"})}
            >
              <AntDesign name="arrowright" size={20} color="white" />
            </TouchableOpacity>
          </View>
        ...
        <View style={styles.containerSection}>
          <View style={styles.headingSecttion}>
            ...
            <TouchableOpacity
              onPress={() => navigation.navigate("ListScreen", {itemType: "manga",title: "Top Manga",type: "manga", subType: "manga"})}
            >
              <AntDesign name="arrowright" size={20} color="white" />
            </TouchableOpacity>
          </View>
          <ListItem data={topManga} navigation={navigation} square type="manga"/>
        </View>
